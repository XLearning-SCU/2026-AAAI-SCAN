...
python 6-fusion.py --dataset flower   --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/flower.log
python 6-fusion.py --dataset cub      --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/cub.log
python 6-fusion.py --dataset pet      --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/petlog
python 6-fusion.py --dataset food     --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/food.log
python 6-fusion.py --dataset aircraft --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/aircraft.log
python 6-fusion.py --dataset car      --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/car.log
python 6-fusion.py --dataset dog      --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/dog.log
python 6-fusion.py --dataset sun      --backbone clip-rn50 --use_ensemble 1 2>&1 | tee logs/fusion/clip-rn50-ensemble/sun.log
